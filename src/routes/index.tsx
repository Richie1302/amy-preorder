  ...
  return (
    <div className="min-h-screen">
      ...
      <footer className="border-t border-border/60 py-10 text-center text-sm text-muted-foreground flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center justify-center gap-1.5 opacity-80 pt-4 border-t border-border/40 w-48 mx-auto">
          <span className="font-medium text-xs uppercase tracking-wider">Built by Richie</span>
          <a href="https://wa.me/234000000000" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-green-600 transition-colors">
